...
class EmptySignal(Signal):
    ...
    def __init__(self, times, value_type=ValueTypes.undefined):
...
class FunctionSignal(Signal):
    ...
    def __init__(self, times, function, value_type=ValueTypes.undefined):
...
class SlowAskaryanSignal(Signal):
    ...
    def __init__(self, times, energy, theta, n=1.78, t0=0):
        ...
        super().__init__(times, values, value_type=ValueTypes.field)
...
class ThermalNoise(Signal):
    ...
    def __init__(self, times, f_band, f_amplitude=1, rms_voltage=None,
        ...
        super().__init__(times, values, value_type=ValueTypes.voltage)
